...
#define Black             0x0000
#define White             0xFFFF
#define Background_window Red_Color  // Popup background color
#define Background_blue   0x1125  // Dark blue background color
//#define Background_black  0x0841  // black background color
#define Background_black  White
#define Font_window       0xD6BA  // Popup font background color
#define Line_Color        0xC618 // Split line color
#define Rectangle_Color   0xCCFF  // blue square cursor color 
#define Red_Color         0xF800
#define Percent_Color     0xFE29  // percentage color
#define BarFill_Color     0xc618  // fill color of progress bar
#define Select_Color      0x0000  // selected color
