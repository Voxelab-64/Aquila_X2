...
void getResetCause(void){
    ...
    printf("[%s]\n",(Set == stcRmuRstCause.enXtalErr)?"Xtal error reset":
                        (Set == stcRmuRstCause.enClkFreqErr)?"Clk freqence error reset":
                        ...
                        (Set == stcRmuRstCause.enPowerOn)?"Power on reset":"unknowCause");
}
